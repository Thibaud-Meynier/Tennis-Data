...
rank_scrap=function(date){
  ...
  for (i in 1:20){
    ...
    if (ncol(rank_scrap)==5 & nrow(rank_scrap)>=50){
      ...
      rank_scrap=data.frame(matrix(ncol = 6,nrow = 0))  
      
      colnames(rank_scrap_end)=c("Rank","Move","Player name","Country","Points","row_number","URL_players")
