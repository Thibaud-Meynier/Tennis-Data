...
load(paste0(getwd(),"/Scrapping tennis data/ML_engenering/MATCH_STATS_DELTA.RData"))

V_MATCH_t = V_MATCH_final_new %>% filter(Season>=year_lim)

rm(V_MATCH_final_new)
...
TABLE = V_MATCH_t %>% 
  mutate(
    Categorie2 = case_when(Categorie %in% c("Team")~"ATP 500",
                           Categorie %in% c("Grand Slam","Masters","Olympics")~"Major",
                           TRUE~Categorie),
    ...
    #  Performance en tant que Favori (Statut basé sur le Rank) - 52 
    F_N_Win_as_Fav_52  = case_when(Rank_W < Rank_L ~ Winner_N_Win_Fav_Rank_52,  TRUE ~ Loser_N_Win_Fav_Rank_52),
    O_N_Win_as_Fav_52  = case_when(Rank_L < Rank_W ~ Winner_N_Win_Fav_Rank_52,  TRUE ~ Loser_N_Win_Fav_Rank_52),
    F_N_Loss_as_Fav_52 = case_when(Rank_W < Rank_L ~ Winner_N_Loss_Fav_Rank_52, TRUE ~ Loser_N_Loss_Fav_Rank_52),
    O_N_Loss_as_Fav_52 = case_when(Rank_L < Rank_W ~ Winner_N_Loss_Fav_Rank_52, TRUE ~ Loser_N_Loss_Fav_Rank_52),
    
    #  Performance en tant qu'Outsider (Statut basé sur le Rank) - 52 
    F_N_Win_as_Out_52  = case_when(Rank_W < Rank_L ~ Winner_N_Win_Out_Rank_52,  TRUE ~ Loser_N_Win_Out_Rank_52),
    O_N_Win_as_Out_52  = case_when(Rank_L < Rank_W ~ Winner_N_Win_Out_Rank_52,  TRUE ~ Loser_N_Win_Out_Rank_52),
    F_N_Loss_as_Out_52 = case_when(Rank_W < Rank_L ~ Winner_N_Loss_Out_Rank_52, TRUE ~ Loser_N_Loss_Out_Rank_52),
    O_N_Loss_as_Out_52 = case_when(Rank_L < Rank_W ~ Winner_N_Loss_Out_Rank_52, TRUE ~ Loser_N_Loss_Out_Rank_52),
    
    #  Calcul des Win Rates Spécifiques - 52 
    F_as_Fav_52_Win_rate = ifelse((F_N_Win_as_Fav_52 + F_N_Loss_as_Fav_52) == 0, 0, 
                                  (F_N_Win_as_Fav_52 / (F_N_Win_as_Fav_52 + F_N_Loss_as_Fav_52)) * 100),
    
    O_as_Fav_52_Win_rate = ifelse((O_N_Win_as_Fav_52 + O_N_Loss_as_Fav_52) == 0, 0, 
                                  (O_N_Win_as_Fav_52 / (O_N_Win_as_Fav_52 + O_N_Loss_as_Fav_52)) * 100),
    
    F_as_Out_52_Win_rate = ifelse((F_N_Win_as_Out_52 + F_N_Loss_as_Out_52) == 0, 0, 
                                  (F_N_Win_as_Out_52 / (F_N_Win_as_Out_52 + F_N_Loss_as_Out_52)) * 100),
    
    O_as_Out_52_Win_rate = ifelse((O_N_Win_as_Out_52 + O_N_Loss_as_Out_52) == 0, 0, 
                                  (O_N_Win_as_Out_52 / (O_N_Win_as_Out_52 + O_N_Loss_as_Out_52)) * 100),
    
    
    # Forme récente - 52 derniers matchs
    F_N_Win_52 = case_when(Rank_W < Rank_L ~ Winner_N_Win_52, TRUE ~ Loser_N_Win_52),
    O_N_Win_52 = case_when(Rank_L < Rank_W ~ Winner_N_Win_52, TRUE ~ Loser_N_Win_52),
    F_N_Loss_52 = case_when(Rank_W < Rank_L ~ Winner_N_Loss_52, TRUE ~ Loser_N_Loss_52),
    O_N_Loss_52 = case_when(Rank_L < Rank_W ~ Winner_N_Loss_52, TRUE ~ Loser_N_Loss_52),
    F_Win_Rate_52 = (F_N_Win_52/(F_N_Win_52+F_N_Loss_52)),
    F_Win_Rate_52 = ifelse(is.na(F_Win_Rate_52),0,F_Win_Rate_52)*100,
    O_Win_Rate_52 = (O_N_Win_52/(O_N_Win_52+O_N_Loss_52)),
    O_Win_Rate_52 = ifelse(is.na(O_Win_Rate_52),0,O_Win_Rate_52)*100,
    
    
    # Forme récente sur surface - 52 derniers matchs
    F_N_Win_s_52 = case_when(Rank_W < Rank_L ~ Winner_N_Win_s_52, TRUE ~ Loser_N_Win_s_52),
    O_N_Win_s_52 = case_when(Rank_L < Rank_W ~ Winner_N_Win_s_52, TRUE ~ Loser_N_Win_s_52),
    F_N_Loss_s_52 = case_when(Rank_W < Rank_L ~ Winner_N_Loss_s_52, TRUE ~ Loser_N_Loss_s_52),
    O_N_Loss_s_52 = case_when(Rank_L < Rank_W ~ Winner_N_Loss_s_52, TRUE ~ Loser_N_Loss_s_52),
    F_Win_Rate_s_52 = (F_N_Win_s_52/(F_N_Win_s_52+F_N_Loss_s_52)),
    F_Win_Rate_s_52 = ifelse(is.na(F_Win_Rate_s_52),0,F_Win_Rate_s_52)*100,
    O_Win_Rate_s_52 = (O_N_Win_s_52/(O_N_Win_s_52+O_N_Loss_s_52)),
    O_Win_Rate_s_52 = ifelse(is.na(O_Win_Rate_s_52),0,O_Win_Rate_s_52)*100,
    ...
    # Categorie tournoi
    Major = case_when(Categorie %in% c("Grand Slam","Masters","Olympics")~1,TRUE~0),
    ATP_1000 = case_when(Categorie %in%"ATP 1000"~1,TRUE~0),
    ATP_500 = case_when(Categorie %in% c("ATP 500","Team")~1,TRUE~0),
  ...
  select(
    ...
    F_N_Loss_as_Out_52,
    O_N_Loss_as_Out_52,
    F_as_Fav_52_Win_rate,
    O_as_Fav_52_Win_rate,
    F_as_Out_52_Win_rate,
    O_as_Out_52_Win_rate,
    F_N_Win_52,
    O_N_Win_52,
    F_N_Loss_52,
    O_N_Loss_52,
...
TABLE_ML_DIFF=TABLE %>% 
  mutate(
    ...
    # --- DIFFÉRENCES - Forme Récente (12 matchs) ---
    Diff_Win_Rate_52 = F_Win_Rate_52 - O_Win_Rate_52,
    Diff_Win_Rate_s_52 = F_Win_Rate_s_52 - O_Win_Rate_s_52,
    ...
    # --- DIFFÉRENCES - Performance As Fav (4 mois) ---
    Diff_as_Fav_52_Win_rate = F_as_Fav_52_Win_rate - O_as_Fav_52_Win_rate,
    
    # --- DIFFÉRENCES - Performance As Out (4 mois) ---
    Diff_as_Out_52_Win_rate = F_as_Out_52_Win_rate - O_as_Out_52_Win_rate,
...
TABLE_MOMENTUM = TABLE_ML_DIFF %>%
  mutate(
    ...
    Mom_WR_52             = sign(Diff_Win_Rate_52),
    Mom_WR_s_52           = sign(Diff_Win_Rate_s_52),
    
    # --- Momentum Statut ---
    Mom_as_Fav_52         = sign(Diff_as_Fav_52_Win_rate),
    Mom_as_Out_52         = sign(Diff_as_Out_52_Win_rate),
  ...
  mutate(
    ...
    Mom_WR_global = Mom_WR_4+Mom_WR_s_4+Mom_WR_12+Mom_WR_s_12+Mom_WR_52+Mom_WR_s_52,
    Mom_Statut = Mom_as_Fav_12+Mom_as_Fav_4+Mom_as_Fav_52+Mom_as_Out_4+Mom_as_Out_12+Mom_as_Out_52,
...
TABLE_MOMENTUM[, Fav_Giant_Killer    := NA_integer_]
TABLE_MOMENTUM[, Out_Giant_Killer    := NA_integer_]
TABLE_MOMENTUM[, Fav_is_finalist     := NA_integer_]
TABLE_MOMENTUM[, Out_is_finalist     := NA_real_]
TABLE_MOMENTUM[, Fav_WR_career       := NA_real_]
TABLE_MOMENTUM[, Out_WR_career       := NA_real_]
TABLE_MOMENTUM[, Fav_WR_career_surface := NA_real_]
TABLE_MOMENTUM[, Out_WR_career_surface := NA_real_]
TABLE_MOMENTUM[, Fav_best_run        := NA_character_]
TABLE_MOMENTUM[, Out_best_run        := NA_character_]
TABLE_MOMENTUM[, Fav_rank_progression := NA_real_]
TABLE_MOMENTUM[, Out_rank_progression := NA_real_]
TABLE_MOMENTUM[, Fav_Max_Points      := NA_real_]
TABLE_MOMENTUM[, Out_Max_Points      := NA_real_]

pb <- txtProgressBar(min = 0, max = nrow(TABLE_MOMENTUM), style = 3)

for (i in seq_len(nrow(TABLE_MOMENTUM))) {
  
  row <- TABLE_MOMENTUM[i]
  ...
  year <- row$Season
  categ <- row$Categorie
  surf <- row$Surface_tournament
  
  TABLE_MOMENTUM[i, Fav_Q            := is_qualies(fav,  date, tourn, year)]
  TABLE_MOMENTUM[i, Out_Q            := is_qualies(out,  date, tourn, year)]
  TABLE_MOMENTUM[i, Fav_Giant_Killer := is_giant_killer(fav,  date)]
  TABLE_MOMENTUM[i, Out_Giant_Killer := is_giant_killer(out,  date)]
  TABLE_MOMENTUM[i, Fav_is_finalist  := is_finalist(fav,  date)]
  TABLE_MOMENTUM[i, Out_is_finalist  := is_finalist(out,  date)]
  TABLE_MOMENTUM[i, Fav_WR_career    := get_player_win_rate(fav,  date, categ, 365*3, tourn)]
  TABLE_MOMENTUM[i, Out_WR_career    := get_player_win_rate(out,  date, categ, 365*3, tourn)]
  TABLE_MOMENTUM[i, Fav_WR_career_surface := get_player_win_rate_surface(fav,  date, surf, 365*3, tourn)]
  TABLE_MOMENTUM[i, Out_WR_career_surface := get_player_win_rate_surface(out,  date, surf, 365*3, tourn)]
  TABLE_MOMENTUM[i, Fav_best_run     := get_player_best_run(fav,  date, categ)]
  TABLE_MOMENTUM[i, Out_best_run     := get_player_best_run(out,  date, categ)]
  TABLE_MOMENTUM[i, Fav_rank_progression := evol_rank(fav,  date, 365)]
  TABLE_MOMENTUM[i, Out_rank_progression := evol_rank(out,  date, 365)]
  TABLE_MOMENTUM[i, Fav_Max_Points   := best_rank(fav,  date, FALSE)]
  TABLE_MOMENTUM[i, Out_Max_Points   := best_rank(out,  date, FALSE)]
...
TABLE_MOMENTUM_NEW = TABLE_MOMENTUM %>% 
...
load("~/work/Tennis-Data/Scrapping tennis data/ML_engenering/TABLE_MOMENTUM.RData")

TABLE_MOMENTUM = rbind(TABLE_MOMENTUM,TABLE_MOMENTUM_NEW)

save(TABLE_MOMENTUM,file=paste0(here(),"/Scrapping tennis data/ML_engenering/TABLE_MOMENTUM.RData"),
     compress ="xz" )

#write.table(TABLE_MOMENTUM,file=paste0(here(),"//Scrapping tennis data/ML_engenering/Data.csv"),sep=";")
