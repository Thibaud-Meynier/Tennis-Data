...
for (i in seq_len(nrow(TABLE_MOMENTUM))) {
  ...
  TABLE_MOMENTUM[i, Fav_WR_career    := get_player_win_rate(fav,  date, categ, 365*3)]
  TABLE_MOMENTUM[i, Out_WR_career    := get_player_win_rate(out,  date, categ, 365*3)]
  TABLE_MOMENTUM[i, Fav_WR_career_surface := get_player_win_rate_surface(fav,  date, surf, 365*3)]
  TABLE_MOMENTUM[i, Out_WR_career_surface := get_player_win_rate_surface(out,  date, surf, 365*3)]
