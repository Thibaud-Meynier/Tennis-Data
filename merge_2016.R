...
path_16='C:/Users/Thiti/Desktop/Tennis-Data/Bet_data/2016.xlsx'

data_16=read_xlsx(path=path_16)
...
x=unique(data_16$Tournament) %>% data.frame()
...
Round_pivot=data.frame(Round_data2=unique(data_16$Round),
...
data_16$Tournament[data_16$Tournament=="French Open"]="Roland Garros"
data_16$Series[data_16$Location=="Hamburg"]="ATP500"
data_16$Series[data_16$Location=="Nottingham"]="ATP250"

data_16=data_16 %>% left_join(Round_pivot %>% select(Round_data2,Round_H),by=c("Round"="Round_data2")) %>% 
...
data_16$WRank=ifelse(data_16$WRank=="N/A",1000,data_16$WRank)
data_16$WPts=ifelse(data_16$WPts=="N/A",10,data_16$WPts)
data_16$LRank=ifelse(data_16$LRank=="N/A",1000,data_16$LRank)
data_16$LPts=ifelse(data_16$LPts=="N/A",10,data_16$LPts)
...
merge=sqldf("select distinct a.*,b.date,b.W1,b.L1,b.W2,b.L2,b.W3,b.L3,b.W4,b.L4,b.W5,b.L5,b.Wsets,b.Lsets,
      ...
      from data2 a 
      left join data_16 b on B.Round_H=a.Round_H and b.WPts=a.winner_rank_points and b.LPts=a.loser_rank_points and b.tourney_name=a.tourney_name")
...
Summary2=data_16 %>% group_by(Tournament) %>% summarise("NB"=sum(is.na(AvgW))) %>% filter(NB>0)
