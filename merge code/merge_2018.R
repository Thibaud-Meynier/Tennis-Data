...
path_18='C:/Users/Thiti/Desktop/Tennis-Data/Bet_data/2018.xlsx'

data_18=read_xlsx(path=path_18)
...
x=unique(data_18$Tournament) %>% data.frame()
...
Round_pivot=data.frame(Round_data2=unique(data_18$Round),
...
data_18$Tournament[data_18$Tournament=="French Open"]="Roland Garros"
data_18$Series[data_18$Location=="Hamburg"]="ATP500"

data_18=data_18 %>% left_join(Round_pivot %>% select(Round_data2,Round_H),by=c("Round"="Round_data2")) %>% 
...
data_18$WRank=ifelse(data_18$WRank=="N/A",1000,data_18$WRank)
data_18$WPts=ifelse(data_18$WPts=="N/A",10,data_18$WPts)
data_18$LRank=ifelse(data_18$LRank=="N/A",1000,data_18$LRank)
data_18$LPts=ifelse(data_18$LPts=="N/A",10,data_18$LPts)
...
merge=sqldf("select distinct a.*,b.date,b.W1,b.L1,b.W2,b.L2,b.W3,b.L3,b.W4,b.L4,b.W5,b.L5,b.Wsets,b.Lsets,
      ...
      from data2 a 
      left join data_18 b on B.Round_H=a.Round_H and b.WPts=a.winner_rank_points and b.LPts=a.loser_rank_points and b.tourney_name=a.tourney_name")
...
Summary2=data_18 %>% group_by(Tournament) %>% summarise("NB"=sum(is.na(AvgW))) %>% filter(NB>0)
