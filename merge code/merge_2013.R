...
path_13='C:/Users/Thiti/Desktop/Tennis-Data/Bet_data/2013.xlsx'

data_13=read_xlsx(path=path_13)
...
x=unique(data_13$Tournament) %>% data.frame()
...
Round_pivot=data.frame(Round_data2=unique(data_13$Round),
...
data_13$Tournament[data_13$Tournament=="French Open"]="Roland Garros"
data_13$Series[data_13$Location=="Hamburg"]="ATP500"
#data_13$Series[data_13$Location=="Nottingham"]="ATP250"
data_13$Surface[data_13$Location=="Bogota"]="Hard"

data_13=data_13 %>% left_join(Round_pivot %>% select(Round_data2,Round_H),by=c("Round"="Round_data2")) %>% 
...
data_13$WRank=ifelse(data_13$WRank=="N/A",1000,data_13$WRank)
data_13$WPts=ifelse(data_13$WPts=="N/A",10,data_13$WPts)
data_13$LRank=ifelse(data_13$LRank=="N/A",1000,data_13$LRank)
data_13$LPts=ifelse(data_13$LPts=="N/A",10,data_13$LPts)
...
merge=sqldf("select distinct a.*,b.date,b.W1,b.L1,b.W2,b.L2,b.W3,b.L3,b.W4,b.L4,b.W5,b.L5,b.Wsets,b.Lsets,
      ...
      from data2 a 
      left join data_13 b on B.Round_H=a.Round_H and b.WPts=a.winner_rank_points and b.LPts=a.loser_rank_points and b.tourney_name=a.tourney_name")
...
Summary2=data_13 %>% group_by(Tournament) %>% summarise("NB"=sum(is.na(AvgW))) %>% filter(NB>0)
